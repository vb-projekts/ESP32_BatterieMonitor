...
const char* VERSION_URL  = "http://192.168.178.46:5000/firmware/version";
const char* FIRMWARE_URL = "http://192.168.178.46:5000/firmware/download";
...
void handleOtaUpdate() {
  ...
  if (code == 200) {
    ...
    // Pruefen ob aktuelle Version im JSON vorkommt
    // Wenn nicht -> neue Version verfuegbar
    if (body.indexOf(FIRMWARE_VERSION) == -1) {
      ...
      switch (ret) {
        case HTTP_UPDATE_OK:
          // ESP32 startet automatisch neu - wird nicht erreicht
          break;
